  ...
  <div class="bg-white border rounded-lg p-4 shadow-sm">
    <div class="flex items-center justify-between">
      <div class="flex items-center space-x-3">
        ...
        <div>
          <div class="text-sm text-gray-600">コイン残高</div>
          <div class="font-semibold text-lg">{{ coinBalance }} コイン</div>
        </div>
      </div>
    ...
    <!-- Recent Transactions -->
    <div v-if="recentTransactions.length > 0" class="mt-4 pt-4 border-t">
      <h4 class="text-sm font-medium text-gray-900 mb-2">最近の取引</h4>
      <div class="space-y-2">
        <div
        ...
        >
          ...
          <div class="flex items-center space-x-1">
            ...
            <span class="text-gray-500">コイン</span>
          </div>
        </div>
      </div>
    </div>
