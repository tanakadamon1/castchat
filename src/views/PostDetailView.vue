    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div
        ...
        :class="[
          ...
          post.isPriority ? 'border-2 border-yellow-400 dark:border-yellow-500' : ''
        ]"
      >
        <!-- Header -->
            ...
            <div class="grid gap-4" :class="imageGridClasses">
              ...
              >
                <LazyImage
                  ...
                  image-class="w-full h-auto object-contain transition-transform duration-200 group-hover:scale-105"
                  :eager="index === 0"
                />
